...
insert into status (type,value) values ('order','rejected');
...
insert into status (type,value) values ('purchase','submitted');
insert into status (type,value) values ('purchase','in_progress');
insert into status (type,value) values ('purchase','completed');
insert into status (type,value) values ('purchase','rejected');