{include file="header.tpl" title="Login" showheader="no" jsload = "ajax"}
		...
		<div class="login">
			<div class="login-in">
				<div class="logo-name">
					<h1><a href = "http://collabtive.o-dyn.de/" title = "{$settings.name} Open Source project management"><img src="./templates/standard/images/logo-a1.png" alt="{$settings.name}"  /></a></h1>
