  ...
  <div id="content-left-in">
    ...
    <div class="infowin_left" style="display:none;" id="systemmsg">
      {if $mode == "projectadded"}
        <span class="info_in_green"><img src="templates/standard/images/symbols/projects.png"
                                         alt=""/>{#projectwasadded#}</span>
      {/if}

      {*for async display*}
      <span id="closed" style="display:none;" class="info_in_green"><img
                src="templates/standard/images/symbols/projects.png" alt=""/>{#projectwasclosed#}</span>
      <span id="deleted" style="display:none;" class="info_in_red"><img
                src="templates/standard/images/symbols/projects.png" alt=""/>{#projectwasdeleted#}</span>
    </div>
    ...
    {if $smarty.session.userRole != 7 && $smarty.session.userRole != 8 && $smarty.session.userRole != 9}
      <div class="projects">
        <div class="headline">
          <a href="javascript:void(0);" id="projecthead_toggle" class="{$projectbar}"
             onclick="toggleBlock('projecthead');"></a>
          {if $userpermissions.projects.add}
            <div class="wintools">
              <a class="add" href="javascript:blindtoggle('form_addmyproject');" id="add_myprojects"
                 onclick="toggleClass(this,'add-active','add');toggleClass('add_butn_myprojects','butn_link_active','butn_link');"><span>{#addproject#}</span></a>
            </div>
          {/if}
          <h2>
            <a href="myprojects.php" title="{#myprojects#}"><img src="./templates/standard/images/symbols/projects.png"
                                                                 alt=""/>{#myprojects#}</a>
          </h2>
        </div>
        ...
        <div class="block" id="projecthead" style="{$projectstyle}">{*Add Project*}
          ...
          {if $smarty.session.userRole < 6}
            <div class="row" style="">
              ...
              <select name="criteriaCustomer" id="criteriaCustomer" onchange="onDeskTopCustomerChange(this)" ;
                      required="1" class="critler-filter">
            ...
            <div class="row">
              ...
              <input id="porject-filter" class="critler-filter" placeholder="Filter by Project Name or Project No" data-type="project" data-data-source="_getProjects4HomePage()">
            </div>
          {/if}
          <div id="desktop-project-table" class="height500">
            <table id="desktopprojects" cellpadding="0" cellspacing="0" border="0" class="notruncation">
              ...
              <tr>
                <th class="a"></th>
                <th class="b" style="cursor:pointer; width:300px"
                    onclick="sortBlock('desktopprojects','');">{#project#}</th>
                <th class="b" style="cursor:pointer; width:100px"
                    onclick="sortBlock('desktopprojects','');">{#projectNo#}</th>
                <th class="c" style="cursor:pointer" onclick="sortBlock('desktopprojects','done');">{#done#}</th>
                <th class="d" style="text-align:right;width:70px"
                    onclick="sortBlock('desktopprojects','daysleft');">{#daysleft#}&nbsp;&nbsp;</th>
                <th class="tools"></th>
              </tr>
              </thead>
              ...
              {section name=project loop=$myprojects}
                ...
                {if $smarty.section.project.index % 2 == 0}
                  <tbody class="color-a" id="proj_{$myprojects[project].ID}"
                         rel="{$myprojects[project].ID},{$myprojects[project].name},{$myprojects[project].daysleft},0,0,{$myprojects[project].done}">
                  {else}
                ...
                <tr {if $myprojects[project].daysleft < 0 && $myprojects[project].daysleft != ""} class="marker-late project-row"{elseif $myprojects[project].daysleft == "0"} class="marker-today project-row"{/if}
                  ...
                  <td>
                    {if $smarty.session.userRole < 5}
                      <a class="butn_check"
                         href="javascript:closeElement('proj_{$myprojects[project].ID}','manageproject.php?action=close&amp;id={$myprojects[project].ID}');"
                         title="{#close#}"></a>
                    {/if}
                  </td>
                  <td>
                    <div class="toggle-in111">
                      <span id="desktopprojectstoggle{$myprojects[project].ID}" class="acc-toggle"
                            onclick="javascript:accord_projects.activate($$('#projecthead .accordion_toggle')[{$smarty.section.project.index}]);toggleAccordeon('projecthead',this);"></span>
                      <a href="manageproject.php?action=showproject&amp;id={$myprojects[project].ID}"
                         title="{$myprojects[project].name}">
                  ...
                  <td class="tools">
                    ...
                    {if $smarty.session.userRole < 5}
                      <a class="tool_del"
                         href="javascript:confirmfunction('{#confirmdel#}','deleteElement(\'proj_{$myprojects[project].ID}\',\'manageproject.php?action=del&amp;id={$myprojects[project].ID}\')');"
                         title="{#delete#}"></a>
                    {/if}
                  </td>
                </tr>
            ...
            <div class="tablemenue-in">
              {if $userpermissions.projects.add}
                <a class="butn_link" href="javascript:blindtoggle('form_addmyproject');" id="add_butn_myprojects"
                   onclick="toggleClass('add_myprojects','add-active','add');toggleClass(this,'butn_link_active','butn_link');toggleClass('sm_myprojects','smooth','nosmooth');">{#addproject#}</a>
              {/if}
            </div>
          </div>
        </div> {*block END*}
    ...
    {if 1 > 0}
      <div class="tasks">
        <div class="headline">
          ...
          <h2>
            <a href="mytasks.php" title="{#mytasks#}"><img src="./templates/standard/images/symbols/tasklist.png"
                                                           alt=""/>{#mytasks#}</a>
          </h2>
        </div>
        ...
        <div class="block" id="taskhead" style="{$taskstyle}" class="height500">
          ...
          <table id="desktoptasks" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
              ...
              <th class="d" style="cursor:pointer;text-align:right"
                  onclick="sortBlock('desktoptasks','daysleft');">{#daysleft#}&nbsp;&nbsp;</th>
              <th class="tools"></th>
            </tr>
            </thead>
            ...
            {section name = task loop=$tasks}
              ...
              {if $smarty.section.task.index % 2 == 0}
                <tbody class="color-a" id="task_{$tasks[task].ID}"
                       rel="{$tasks[task].ID},{$tasks[task].title},{$tasks[task].daysleft},{$tasks[task].pname}">
                {else}
              ...
              <tr {if $tasks[task].daysleft < 0} class="marker-late"{elseif $tasks[task].daysleft == 0} class="marker-today"{/if}>
                <td>
                  {if $userpermissions.tasks.close and $tasks[task].editable != 'false'}
                    <a class="butn_check"
                       href="javascript:closeElement('task_{$tasks[task].ID}','managetask.php?action=close&amp;tid={$tasks[task].ID}&amp;id={$tasks[task].project}');"
                       title="{#close#}"></a>
                  {/if}
                </td>
                <td>
                  <div class="toggle-in">
                    <span id="desktoptaskstoggle{$tasks[task].ID}" class="acc-toggle"
                          onclick="javascript:accord_tasks.activate($$('#taskhead .accordion_toggle')[{$smarty.section.task.index}]);toggleAccordeon('taskhead',this);"></span>
                    <a href="managetask.php?action=showtask&amp;id={$tasks[task].project}&amp;tid={$tasks[task].ID}"
                ...
                <td class="tools">
                  {if $userpermissions.tasks.edit and $tasks[task].editable != 'false'}
                    <a class="tool_edit"
                       href="managetask.php?action=editform&amp;tid={$tasks[task].ID}&amp;id={$tasks[task].project}"
                       title="{#edit#}"></a>
                  {/if}
                  {if $userpermissions.tasks.del and $tasks[task].editable != 'false'}
                    <a class="tool_del"
                       href="javascript:confirmfunction('{#confirmdel#}','deleteElement(\'task_{$tasks[task].ID}\',\'managetask.php?action=del&amp;tid={$tasks[task].ID}&amp;id={$tasks[task].project}\')');"
                       title="{#delete#}"></a>
                  {/if}
                </td>
              </tr>
    ...
    <div class="tasks">
      <div class="headline">
        <a href="javascript:void(0);" id="my-taskhead_toggle" class="{$taskbar}"
           onclick="toggleBlock('my-taskhead');"></a>
      ...
      <div class="block" id="my-taskhead" style="{$taskstyle}" class="height500">
        ...
        <table id="desktoptasks" cellpadding="0" cellspacing="0" border="0">
          ...
          {section name = task loop=$myRequestedTasks}
            {*Color-Mix*}
            {if $smarty.section.task.index % 2 == 0}
              <tbody class="color-a" id="task_{$myRequestedTasks[task].ID}"
                     rel="{$myRequestedTasks[task].ID},{$myRequestedTasks[task].title},{$myRequestedTasks[task].daysleft},{$myRequestedTasks[task].pname}">
              {else}
            ...
            <tr {if $myRequestedTasks[task].daysleft < 0} class="marker-late"{elseif $myRequestedTasks[task].daysleft == 0} class="marker-today"{/if}>
              <td>
                {if $userpermissions.tasks.close and $myRequestedTasks[task].editable != 'false'}
                  <a class="butn_check"
                     href="javascript:closeElement('task_{$myRequestedTasks[task].ID}','managetask.php?action=close&amp;tid={$myRequestedTasks[task].ID}&amp;id={$myRequestedTasks[task].project}');"
                     title="{#close#}"></a>
                {/if}
              </td>
              <td>
                <div class="toggle-in">
                  <span id="desktoptaskstoggle{$myRequestedTasks[task].ID}" class="acc-toggle"
                        onclick="javascript:accord_tasks.activate($$('#my-taskhead .accordion_toggle')[{$smarty.section.task.index}]);toggleAccordeon('taskhead',this);"></span>
                  <a href="managetask.php?action=showtask&amp;id={$myRequestedTasks[task].project}&amp;tid={$myRequestedTasks[task].ID}"
                     title="{$myRequestedTasks[task].title}">
              ...
              <td class="tools">
                {if $userpermissions.tasks.edit and $myRequestedTasks[task].editable != 'false'}
                  <a class="tool_edit"
                     href="managetask.php?action=editform&amp;tid={$myRequestedTasks[task].ID}&amp;id={$myRequestedTasks[task].project}"
                     title="{#edit#}"></a>
                {/if}
                {if $userpermissions.tasks.del and $myRequestedTasks[task].editable != 'false'}
                  <a class="tool_del"
                     href="javascript:confirmfunction('{#confirmdel#}','deleteElement(\'task_{$myRequestedTasks[task].ID}\',\'managetask.php?action=del&amp;tid={$myRequestedTasks[task].ID}&amp;id={$myRequestedTasks[task].project}\')');"
                     title="{#delete#}"></a>
                {/if}
              </td>
            </tr>
    ...
    {if $smarty.session.userRole < 6}
      <div class="msgs">
        <div class="headline">
          <a href="javascript:void(0);" id="activityhead_toggle" class="{$actbar}"
          ...
          <div class="wintools">
            <div class="export-main">
              ...
              <div class="export-in" style="width:46px;left: -46px;"> {*at one item*}
                ...
                <a class="pdf"
                   href="managemessage.php?action=mymsgs-pdf&amp;id={$userid}"><span>{#pdfexport#}</span></a>
              </div>
            </div>
          </div>

          <h2>
            <a href="managemessage.php?action=mymsgs" title="{#mymessages#}"><img
                      src="./templates/standard/images/symbols/msgs.png" alt=""/>{#mymessages#}</a>
          </h2>
        </div>
              ...
              <tr>
                <td>
                  {if $userpermissions.messages.close}
                    <a class="butn_reply"
                       href="managemessage.php?action=replyform&amp;mid={$messages[message].ID}&amp;id={$messages[message].project}"
                       title="{#answer#}"></a>
                  {/if}
                </td>
                <td>
                  <div class="toggle-in">
                    <span class="acc-toggle"
                          onclick="javascript:accord_msgs.activate($$('#activityhead .accordion_toggle')[{$smarty.section.message.index}]);toggleAccordeon('activityhead',this);"></span>
                    <a href="managemessage.php?action=showmessage&amp;mid={$messages[message].ID}&amp;id={$messages[message].project}"
                       title="{$messages[message].title}">{$messages[message].title|truncate:35:"...":true}</a>
                  </div>
                </td>
                <td>
                ...
                <td class="tools">
                  {if $userpermissions.messages.edit}
                    <a class="tool_edit"
                       href="managemessage.php?action=editform&amp;mid={$messages[message].ID}&amp;id={$messages[message].project}&amp;redir=index.php"
                       title="{#edit#}"></a>
                  {/if}
                  {if $userpermissions.messages.del}
                    <a class="tool_del"
                       href="javascript:confirmfunction('{#confirmdel#}','deleteElement(\'messages_{$messages[message].ID}\',\'managemessage.php?action=del&amp;mid={$messages[message].ID}&amp;id={$messages[message].project}\')');"
                       title="{#delete#}"></a>
                  {/if}
                </td>
              </tr>
                    ...
                    <div class="acc-in">
                      ...
                      {else}
                        {if $messages[message].gender == "f"}
                          <div class="avatar"><img
                                    src="thumb.php?width=80&amp;height=80&amp;pic=templates/standard/images/no-avatar-female.jpg"
                                    alt=""/></div>
                        {else}
                          <div class="avatar"><img
                                    src="thumb.php?width=80&amp;height=80&amp;pic=templates/standard/images/no-avatar-male.jpg"
                                    alt=""/></div>
                        {/if}
                      {/if}
                      <div class="message">
                                  ...
                                  <div class="itemwrapper" id="iw_{$messages[message].files[file].ID}">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0">
                                      <tr>
                                        ...
                                        <td class="thumb">
                                          <a href="{$messages[message].files[file].datei}" {if $messages[message].files[file].imgfile == 1} rel="lytebox[]" {elseif $messages[message].files[file].imgfile == 2} rel="lyteframe[text]" {/if}
                                             title="{$messages[message].files[file].name}">
                                            {if $messages[message].files[file].imgfile == 1}
                                              <img src="thumb.php?pic={$messages[message].files[file].datei}&amp;width=32"
                                                   alt="{$ordner[file].name}"/>
                                            {else}
                                              <img src="templates/standard/images/files/{$messages[message].files[file].type}.png"
