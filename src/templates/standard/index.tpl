...
<div id="content-left">
    ...
    <div class="tasks">
      <div class="headline">
        <a href="javascript:void(0);" id="my-taskhead_toggle" class="{$taskbar}" onclick = "toggleBlock('my-taskhead');"></a>
        ...
        <h2>
          <a href="mytasks.php" title="{#mytasks#}"><img src="./templates/standard/images/symbols/tasklist.png" alt="" />{#myrequestedtasks#}</a>
        </h2>
      </div>
