        ...
        <div id = "internalpricebreakdownToggle" class="block_in_wrapper" >
          <form onsubmit="return validateCompleteForm(this);" action="manageinternalpricebreakdown.php?action=update" method="post" class="main" style="padding-bottom:20px">
            ...
            <div class="row">
              ...
              <input id = "jenkins_model_number" name ="jenkins_model_number" value="{$internalpricebreakdown.jenkins_model_number}"   regexp="{literal}^\d*${/literal}" ></input>
            </div>
            ...
            <div class="row">
              ...
              <input id = "jenkins_drawing_number" name ="jenkins_drawing_number" value="{$internalpricebreakdown.jenkins_drawing_number}"   regexp="{literal}^\d*${/literal}" ></input>
            </div>
