        ...
        <div id="documenthead" class="block">
          ...
          <form class="main">
            ...
            <div class="row">
              ...
              <select class="select2 critler-filter" name="criteriaProject" id="criteriaProject" onchange="onCriteriaProjectChange(this)"; required = "1">
            ...
            <div class="row">
              ...
              <select class="select2 critler-filter" name="criteriaCustomer" id="criteriaCustomer" onchange="onCriteriaCustomerChange(this)"; required = "1">
                <option value="-1" selected="selected">{#chooseone#}</option>
            ...
            <div class="row">
              ...
              <select class="select2 critler-filter" name="criteriaOrder" id="criteriaOrder" onchange="onCriteriaOrderChange(this)"; required = "1">
                <option value="-1" selected="selected">{#chooseone#}</option>
          ...
          <div class="tablemenue">
            <div class="tablemenue-in">
              <a onclick="toggleClass(this,'add-active','add');toggleClass(this,'butn_link_active','butn_link');disableUploadBtn();" id="add_butn_myprojects" href="javascript:blindtoggle('form_adddecn');" class="butn_link">{#addECR#}</a>
            </div>
          </div>
