...
<body style="background: url(/templates/standard/images/tables-projects-sechead.png) repeat scroll 0 0 transparent;">
  <div class="projects block_in_wrapper" >
    ...
    <form onsubmit="return validateCompleteForm(this);" action="managecost.php?action=update" method="post" class="main">
      ...
      <div class="row">
        <label style="width:240px;" >{#project#}</label>
        <input id = "project" name ="project" value="{$cost.project}"></input>
      </div>
      ...
      <div class="row">
        ...
        <input id = "jenkins_model_number" name ="jenkins_model_number" value="{$cost.jenkins_model_number}"></input>
      </div>
      ...
      <div class="row">
        ...
        <input id = "jenkins_drawing_number" name ="jenkins_drawing_number" value="{$cost.jenkins_drawing_number}"></input>
      </div>
      ...
      <div class="row">
        ...
        <input id = "internal_budgetary_price" name ="internal_budgetary_price" value="{$cost.internal_budgetary_price}"></input>
      </div>
      
      <div class="row">
        <label style="width:240px;" >{#externalbudgetaryprice#}</label>
        <input id = "external_budgetary_price" name ="external_budgetary_price" value="{$cost.external_budgetary_price}"></input>
      </div>
      
      <div class="row">
        <label style="width:240px;" >{#internalalphaprice#}</label>
        <input id = "internal_alpha_price" name ="internal_alpha_price" value="{$cost.internal_alpha_price}"></input>
      </div>
      
      <div class="row">
        <label style="width:240px;" >{#externalalphaprice#}</label>
        <input id = "external_alpha_price" name ="external_alpha_price" value="{$cost.external_alpha_price}"></input>
      </div>
      
      <div class="row">
        <label style="width:240px;" >{#internalbetaprice#}</label>
        <input id = "internal_beta_price" name ="internal_beta_price" value="{$cost.internal_beta_price}"></input>
      </div>
      
      <div class="row">
        <label style="width:240px;" >{#externalbetaprice#}</label>
        <input id = "external_beta_price" name ="external_beta_price" value="{$cost.external_beta_price}"></input>
      </div>
      
      <div class="row">
        <label style="width:240px;" >{#internalfinalprice#}</label>
        <input id = "internal_final_price" name ="internal_final_price" value="{$cost.internal_final_price}"></input>
      </div>
      
      <div class="row">
        <label style="width:240px;" >{#quantityperproduct#}</label>
        <input id = "quantity_per_product" name ="quantity_per_product" value="{$cost.quantity_per_product}"></input>
      </div>
      
      <div class="row">
        <label style="width:240px;" >{#currency#}</label>
        <input id = "currency" name ="currency" value="{$cost.currency}"></input>
      </div>
