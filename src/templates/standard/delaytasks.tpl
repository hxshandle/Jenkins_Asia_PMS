...
{include file="tabsmenue-desk.tpl" delaytasktab = "active"}
        ...
        <div id="delaytaskhead" class="block">
          ...
          <form class="main">
            ...
            <div class="row">
              ...
              <select name="criteriaCustomer" id="criteriaCustomer" onchange='onNormalSelCustomerChange(this,"managedelaytasks.php?action=filterDelayTasks","delayTaskTableContainer")'; required = "1">
          ...
          {include file="delaytaskTable.tpl"}
          </div>
